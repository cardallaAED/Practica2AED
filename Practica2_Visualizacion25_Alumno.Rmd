...
grafico2<-ggplot(ds, aes(x= MinTemp, y= MaxTem, colour = ds$RainTomorrow))+geom_point()
...
ggplot(ds,aes(x= Temp9am, y= Pressure9am,shape=ds$RainToday, colour = RainToday) )+geom_point()
