...
ggplot(data=ice.river.df, aes(x=flow.vat, y=flow.jok, )) +geom_line()+geom_point()+labs(title = "Caudales de los rios islandeses Vatnsdalsa(azul) y Jokulsa Eystri(rojo)")
